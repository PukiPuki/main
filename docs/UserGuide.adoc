...
[NOTE]
`Spaced Repetition` is the idea that spreading out study sessions is much more effective than cramming it ove rone night.
...
This document is prepared for consumers with varying level of technical proficiency in mind.
...
Managing Card section contains all the information you need to add, select, edit cards and more.
...
Managing Tags is one of our key features too.
It allows you to filter for cards that you want to quicky find that needle in the haystack.
...
Another way you can do it is to simply click on the flashcard.
...
* `answer c/1` Passable +
I think of know the answer, but need more practice. Card will then be scheduled for the near future. To get more practice.
* `answer c/2` Easy A+ +
